...
// sha3: 5b3e9b4813e2ff24d9b6efb7e823f6afcc23c8157292261175d9b2721e3479
use std::str::FromStr;
...
mod __parse__Expr {
    ...
    {
        // Expr = Expr, AdditionOp, Factor => ActionFn(1);
    ...
    {
        // Factor = Factor, MulOp, UnaryNeg => ActionFn(5);
        assert!(__symbols.len() >= 3);
        let __sym2 = __pop_Variant2(__symbols);
        let __sym1 = __pop_Variant1(__symbols);
        let __sym0 = __pop_Variant2(__symbols);
